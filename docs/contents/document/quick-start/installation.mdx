...
1. Navigate to the [MCP Server Template repository](https://github.com/Chisanan232/Template-Python-Base-MCP-Server)
2. Click the **"Use this template"** button (green button)
3. Select **"Create a new repository"**
4. Configure your new repository:
   - **Repository name**: Enter your MCP server project name
...
```bash
git clone https://github.com/Chisanan232/Template-Python-Base-MCP-Server.git my-new-mcp-server
...
1. Go to the [MCP Server Template repository](https://github.com/Chisanan232/Template-Python-Base-MCP-Server)
2. Click **"Code"** → **"Download ZIP"**
3. Extract the ZIP file to your desired location
4. Rename the folder to your MCP server project name
