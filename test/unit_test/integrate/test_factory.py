...
from src.integrate.app import IntegratedServerFactory, integrated_factory, _INTEGRATED_SERVER_INSTANCE, integrated_server_lifecycle
...
class TestIntegratedFactoryInstance:
    ...
    def test_integrated_factory_reset(self) -> None:
        ...
        with patch('src.integrate.app.mcp_factory') as mock_mcp_factory, \
...
class TestIntegratedServerIntegration:
    ...
    def test_transport_mounting(self, mock_web_factory: MagicMock, mock_mcp_factory: MagicMock) -> None:
        ...
        # Mock factories
        mock_web_app = MagicMock()
        mock_web_factory.get.side_effect = [AssertionError("Not created"), mock_web_app, AssertionError("Not created"), mock_web_app]
        mock_web_factory.create.return_value = mock_web_app
