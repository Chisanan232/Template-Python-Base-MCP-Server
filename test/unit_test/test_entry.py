...
class TestRunStandaloneServer:
    ...
    def test_run_sse_transport(self, mock_mcp_factory: MagicMock,
                              mock_init_env: MagicMock) -> None:
        ...
        with patch('src.web_server.app.create_app') as mock_create_app, \
             patch('src.entry.uvicorn.run') as mock_uvicorn:
...
class TestRunIntegratedServer:
    ...
    def test_run_integrated_success(self, mock_integrated_factory: MagicMock,
                                   mock_init_env: MagicMock) -> None:
    ...
    @patch('src.entry.initialize_server_environment')
    @patch('src.entry.integrated_factory')
    def test_run_integrated_invalid_transport(self, mock_integrated_factory: MagicMock,
                                           mock_init_env: MagicMock) -> None:
...
class TestMain:
    ...
    def test_main_integrated_mode(self, mock_parse_args: MagicMock,
                                 mock_create_server_config: MagicMock,
                                 mock_run_integrated_server: MagicMock) -> None:
    ...
    @patch('src.entry.create_server_config')
    @patch('src.entry.parse_args')
    def test_main_standalone_mode(self, mock_parse_args: MagicMock,
                                  mock_create_server_config: MagicMock,
                                  mock_run_standalone_server: MagicMock) -> None:
    ...
    @patch('src.entry.create_server_config')
    @patch('src.entry.parse_args')
    def test_main_with_argv(self, mock_parse_args: MagicMock,
                           mock_create_server_config: MagicMock,
                           mock_run_standalone_server: MagicMock) -> None:
    ...
    @patch('src.entry.create_server_config')
    @patch('src.entry.parse_args')
    def test_main_config_validation_error(self, mock_parse_args: MagicMock,
                                         mock_create_server_config: MagicMock) -> None:
